<div class="container mt-4">
    <div class="row mb-4">
        <div class="col-12">
            ...
            <p>Hello Admin: <?= htmlspecialchars($_SESSION['user_name']) ?></p>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card h-100" style="border: 1px solid var(--border); border-radius: var(--radius); transition: transform 0.2s;">
                    <div class="card-body p-4 d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center text-muted fs-body2 mt-auto" style="font-size: 0.875rem;">
                            <span class="me-3">
                                By: <span class="font-weight-bold text-primary">
                                    <?= htmlspecialchars($question['username'] ?? 'Anonymous') ?>
                                </span>
                            </span>
                            <span class="me-3">
                                Module: <span class="font-weight-bold badge bg-primary">
                                    <?= htmlspecialchars($question['module'] ?? 'Uncategorized') ?>
                                </span>
                            </span>
                            <span>
                                <?= htmlspecialchars(date('m/d/Y', strtotime($question['date']))) ?>
                            </span>
                        </div>

                        <!-- Action buttons just below info -->
