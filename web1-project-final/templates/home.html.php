<div class="container mt-4">
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h2>Welcome to GrenovateHub, <?php echo strlen($_SESSION['user_name']) > 20 ? htmlspecialchars(substr($_SESSION['user_name'], 0, 20)) . "..." : htmlspecialchars($_SESSION['user_name']);?>!</h2>
    ...
    <div class="row" id="questionsList">
        <?php foreach ($admin_questions as $question): ?>
            <div class="col-md-6 col-lg-4 mb-4">
                <a  href="view_post.php?id=<?php echo htmlspecialchars($question['id']); ?>">    
                    <div class="card h-100">
                        <?php if (!empty($question['image'])): ?>
                            <img src="upload/uploads/<?php echo htmlspecialchars($question['image']); ?>" class="card-img-top" alt="Question Screenshot">
                        <?php endif; ?>
                        <div class="card-body">
                            ...
                            <?php if (!empty($question['user_image'])): ?> 
                                <img src="upload/uploads/<?php echo htmlspecialchars($question['user_image']); ?>" alt="User Image" class="rounded-circle me-2" style="width: 30px; height: 30px; object-fit: cover;">
                            <?php else: ?>   
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user me-2" style="color: var(--foreground); opacity: 0.5;">
                            ...
                            <span class="badge bg-primary mb-2"><?php echo htmlspecialchars($question['module'] ?? 'Uncategorized'); ?></span>
